...
struct config2 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 280;
    static const bool store_weights_in_bram = false;

    static const unsigned rf_pad = 0;
    static const unsigned bf_pad = 0;

    static const unsigned reuse_factor = 140;
...
struct config4 : nnet::dense_config {
    ...
    static const unsigned io_type = nnet::io_parallel;
    static const unsigned n_zeros = 0;
    static const unsigned n_nonzeros = 3136;
    static const bool store_weights_in_bram = false;

    static const unsigned rf_pad = 16;
    static const unsigned bf_pad = 4;
...
struct config8 : nnet::dense_config {
    ...
    static const unsigned io_type = nnet::io_parallel;
    static const unsigned n_zeros = 0;
    static const unsigned n_nonzeros = 392;
    static const bool store_weights_in_bram = false;
