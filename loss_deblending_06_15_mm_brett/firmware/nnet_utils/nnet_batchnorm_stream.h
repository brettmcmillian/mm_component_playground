...
// ****************************************************
template<class data_T,  unsigned int data_N, unsigned int res_N, typename CONFIG_T>
void normalize_binary_tanh(
    stream<data_T, data_N> &data, 
    stream<nnet::array<ac_int<1, false>, CONFIG_T::n_in>, res_N> &res,
...
void normalize_ternary_tanh(
    stream<data_T, data_N> &data, 
    stream<nnet::array<ac_int<2, true>, CONFIG_T::n_in>, res_N> &res,
