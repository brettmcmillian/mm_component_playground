...
output_data policy_int(
    input_data inputs,
    model_default_t w2[ARRAY_SIZES[0]],
    model_default_t b2[ARRAY_SIZES[1]],
    model_default_t w4[ARRAY_SIZES[2]],
    model_default_t b4[ARRAY_SIZES[3]],
    model_default_t w6[ARRAY_SIZES[4]],
    model_default_t b6[ARRAY_SIZES[5]],
    model_default_t w8[ARRAY_SIZES[6]],
    model_default_t b8[ARRAY_SIZES[7]])
{
...
component output_data policy(
	...
	if (i < ARRAY_CUMUL[0]) {
      ...
      outputs = policy_int(inputs, w2, b2, w4, b4, w6, b6, w8, b8);
    }
