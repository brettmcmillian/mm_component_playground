...
typedef ac_fixed<8,3,true,AC_RND_CONV,AC_SAT> conv1d1_bias_t;
...
typedef ac_fixed<8,3,true,AC_RND_CONV,AC_SAT> conv1d2_bias_t;
...
typedef ac_fixed<8,3,true,AC_RND_CONV,AC_SAT> conv1d3_bias_t;
...
typedef ac_fixed<8,3,true,AC_RND_CONV,AC_SAT> conv1d4_bias_t;
...
typedef ac_fixed<8,3,true,AC_RND_CONV,AC_SAT> conv1d5_bias_t;
...
typedef ac_fixed<8,3,true,AC_RND_CONV,AC_SAT> conv1d6_bias_t;
...
typedef ac_fixed<8,3,true,AC_RND_CONV,AC_SAT> conv1d13_bias_t;
...
typedef ac_fixed<8,3,true,AC_RND_CONV,AC_SAT> conv1d14_bias_t;
...
typedef ac_fixed<8,3,true,AC_RND_CONV,AC_SAT> conv1d15_bias_t;
...
typedef ac_fixed<8,3,true, AC_RND_CONV, AC_SAT> conv1d16_bias_t;
...
typedef nnet::array<ac_fixed<16,10,true>, 518*1> layer33_t;
typedef ac_fixed<8,3,true, AC_RND_CONV, AC_SAT> dense1_weight_t;
typedef ac_fixed<8,3,true, AC_RND_CONV, AC_SAT> dense1_bias_t;
typedef ac_int<1, false> layer31_index;
typedef nnet::array<ac_fixed<16,10,true>, 2> result_t;
typedef ac_fixed<8,0,false, AC_RND_CONV, AC_SAT> act2_table_t;
